...
import {MeasuresPath, NormalizedMeasuresPath} from './consts'
import {Measures} from './types'
import {writeFile} from './writeFile'

async function normalizeData() {
	const str = await readFile(MeasuresPath)
	...
	await writeFile(NormalizedMeasuresPath, JSON.stringify(data, null, ' '))
}