 ...
 * components those two name. It imports the published adapter and React and nothing else: no core
 * internal, no `store.edit`, no `store.tokens`. `boundary.spec.ts` one directory up is what makes
