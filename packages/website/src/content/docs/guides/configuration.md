...
**Problem:** Marks aren't showing up

**Solutions:**
1. Check markup pattern matches your text
2. Ensure Mark component is provided
3. Verify slotProps returns valid props

```tsx
// ❌ Wrong
value: '@[Alice]'
markup: '#[__value__]'  // Pattern doesn't match!
...
**Problem:** Type mismatch in slotProps
...
**Solutions:**
1. Check `trigger` matches typed character
2. Verify `data` array has items
3. Ensure `slotProps.overlay` is in correct option
...
- **[Dynamic Marks](./dynamic-marks)** - Make marks editable and removable
- **[Nested Marks](./nested-marks)** - Create hierarchical structures
- **[Overlay Customization](./overlay-customization)** - Build custom autocomplete
