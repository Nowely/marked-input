...
<Aside type="caution" title="Browser Compatibility">
	This example uses the [Popover API](https://developer.mozilla.org/en-US/docs/Web/API/Popover_API), which requires
	Chrome 114+, Edge 114+, or Safari 17+. For broader browser support, use a regular positioned `div` or a third-party
	library like [Floating UI](https://floating-ui.com/).
</Aside>
