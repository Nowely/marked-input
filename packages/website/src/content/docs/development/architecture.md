...
| **RowControls**      | ONE per editor: the gutter's `+` and grip, the drop indicator, the refusal tint and the row menu, painted at measured row boxes |
