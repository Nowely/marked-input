...
```ts
function useControlRef(): RefCallback<HTMLElement>;
```

Defined in: [react/markput/src/lib/hooks/useControlRef.ts:22](https://github.com/Nowely/marked-input/blob/next/packages/react/markput/src/lib/hooks/useControlRef.ts#L22)
