...
Defined in: [core/src/features/tokens/parser/utils/denote.ts:36](https://github.com/Nowely/marked-input/blob/next/packages/core/src/features/tokens/parser/utils/denote.ts#L36)
