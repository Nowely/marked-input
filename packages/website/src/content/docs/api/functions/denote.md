...
Defined in: [core/src/features/tokens/parser/utils/denote.ts:20](https://github.com/Nowely/marked-input/blob/next/packages/core/src/features/tokens/parser/utils/denote.ts#L20)
