...
| `src/features/rows/`      | block layout, drag and per-row UI state                                                                                                                                               |
...
| `MarkputHandle`                                                                                                                           | value        | the ref handle — `container` and `focus()`, reachable as `store.handle`          |
| `TreeNode`, `TextNode`, `MarkNode`, `NodeAnchor`                                                                                          | types        | the live tree: what the adapters render and what `useMark()` hands back          |
